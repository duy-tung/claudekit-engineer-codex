...
For presentation-grade output, apply richer style selection and distinctive font/palette pairing.
...
**AI image generation:** If an image-generation tool is available, use it to generate images for the deck. For any deck over 10 slides, target a minimum of 2–4 images. Priority order:
...
```bash
# Use an available image-generation tool if needed

...
test('computeNextBetaVersion starts next minor after latest stable', () => {
...
test('computeNextBetaVersion increments existing next-minor beta tags', () => {
  assert.deepEqual(
    computeNextBetaVersion('v2.17.0', ['v2.18.0-beta.1', 'v2.18.0-beta.3']),
    {
      stable: '2.17.0',

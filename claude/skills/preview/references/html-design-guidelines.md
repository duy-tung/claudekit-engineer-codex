...
If an image-generation tool is available and appropriate, it can be used for hero banners, conceptual illustrations, and decorative accents that establish the page's visual tone.
...
For `--slides` presentation-grade output, apply richer style selection and distinctive font/palette pairing.

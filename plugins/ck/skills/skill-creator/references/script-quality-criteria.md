...
2. `${CLAUDE_PLUGIN_ROOT}/skills/<skill-name>/.env` (skill-specific)
3. `${CLAUDE_PLUGIN_ROOT}/skills/.env` (shared skills)
4. `$HOME/.claude/.env` (global)
5. `./${CLAUDE_PLUGIN_ROOT}/skills/${SKILL}/.env` (cwd)
6. `./${CLAUDE_PLUGIN_ROOT}/skills/.env` (cwd)
7. `./.claude/.env` (cwd)
...
load_dotenv('${CLAUDE_PLUGIN_ROOT}/skills/.env')
load_dotenv('${CLAUDE_PLUGIN_ROOT}/skills/my-skill/.env')
load_dotenv('./${CLAUDE_PLUGIN_ROOT}/skills/my-skill/.env')
load_dotenv('./${CLAUDE_PLUGIN_ROOT}/skills/.env')
